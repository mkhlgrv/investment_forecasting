...
\setlist[enumerate]{label=\arabic{enumi}),parsep=0em,itemsep=0em,topsep=0.75ex, before={\parskip=-1em}, leftmargin = 18mm}
...
% https://github.com/odomanov/biblatex-gost/wiki/Как-сд..
\DeclareSourcemap{
